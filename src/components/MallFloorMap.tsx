...
const SAMPLE_ZONES: MallZone[] = [
  {
    ...
    solutionStage: 'Станция 1: "Врата Верхнего мира" — Шаман встречает группу зрителей, даёт первое AR-задание.',
    mythicWorld: 'Верхний мир (Үөһээ Дойду)',
    tenantPromo: 'Кофейня "Bean & Brew" на выходе из тупика: +45% конверсия в заказы.',
  },
  {
    id: 'zone-2',
    ...
    tenantPromo: 'Магазин аксессуаров "Nordic": купон 15% при сканировании символа.',
  },
  {
    id: 'zone-3',
